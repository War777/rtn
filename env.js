 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.trn.staging
 */

const BUNDLE_ID = 'com.trn'; // ios bundle id
const PACKAGE = 'com.trn'; // android package name
const NAME = 'trn'; // app name
